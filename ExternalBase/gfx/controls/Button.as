class gfx.controls.Button extends gfx.core.UIComponent
{
   ...
   function configUI()
   {
      ...
      this.onPressAux = this.handleMousePress;
      this.onReleaseAux = this.handleMouseRelease;
      this.onDragOverAux = this.handleDragOver;
      this.onDragOutAux = this.handleDragOut;
      this.onReleaseOutsideAux = this.handleReleaseOutside;
