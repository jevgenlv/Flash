class gfx.controls.TextInput extends gfx.core.UIComponent
{
   ...
   function get IsTextInput()
   {
      return true;
   }
   static function get IsFocus()
   {
      var mc = eval(Selection.getFocus());
      if(mc._parent.IsTextInput == true)
      {
         return true;
      }
      return false;
   }
   static function get IsTextFieldFocus()
   {
      return eval(Selection.getFocus()) instanceof TextField;
   }
   static function get FocusControl()
   {
      var mc = eval(Selection.getFocus());
      if(mc._parent.IsTextInput == true)
      {
   ...
   function changeFocus()
   {
      ...
      {
         fscommand("TextInput","focusIn");
      }
      else
      {
         fscommand("TextInput","focusOut");
      }
      this.tabEnabled = !this._disabled;
      if(!this._focused)
      {
