class gfx.managers.PopUpManager
{
   ...
   static function createPopUp(context, linkage, initProperties, relativeTo)
   {
      ...
      {
         _loc4_ = {x:initProperties._x,y:initProperties._y};
      ...
      var _loc2_ = _loc3_.attachMovie(linkage,"popup" + gfx.managers.PopUpManager.index++,_loc7_,initProperties);
      if(!_loc2_)
      {
   ...
   static function createPopUpRetry(context, linkage, initProperties, relativeTo)
   {
      ...
      if(relativeTo != null)
      {
         _loc2_ = {x:initProperties._x,y:initProperties._y};
