class gfx.core.UIComponent extends MovieClip
{
   ...
   function onLoadImpl()
   {
      ...
      if(this._focused != 0 && Selection.getFocusBitmask(this) == 0)
      {
         ...
         {
            _loc6_ = (this._focused >> _loc4_ & 1) != 0;
            if(_loc6_)
            {
               _loc5_ = Selection.getControllerMaskByFocusGroup(_loc4_);
               _loc3_ = 0;
               while(_loc3_ < System.capabilities.numControllers)
               {
                  if(_loc5_ >> _loc3_ & true)
                  {
                     gfx.managers.FocusHandler.instance.onSetFocus(null,this,_loc3_);
                  }
                  _loc3_ = _loc3_ + 1;
               }
            }
   ...
   function set focused(value)
   {
      ...
      {
         _loc6_ = (this._focused >> _loc3_ & 1) != 0;
         if(_loc6_)
         {
   ...
   function handleInput(details, pathToFocus)
   {
      ...
      {
         _loc2_ = pathToFocus[0];
         if(_loc2_.handleInput)
         {
            _loc3_ = _loc2_.handleInput(details,pathToFocus.slice(1));
            if(_loc3_)
            {
               return _loc3_;
            }
