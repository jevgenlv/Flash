class Common.Controls.MUCoreList extends gfx.core.UIComponent
{
   var __height;
   var __width;
   var _dataProvider;
   ...
   var renderers;
   var tabEnabled;
   var soundMap = {theme:"default",focusIn:"focusIn",focusOut:"focusOut",select:"select",change:"change",rollOver:"rollOver",rollOut:"rollOut",itemClick:"itemClick",itemClickR:"itemClickR",itemDoubleClick:"itemDoubleClick",itemPress:"itemPress",itemRollOver:"itemRollOver",itemRollOut:"itemRollOut"};
   ...
   function setRendererList(value)
   {
      ...
      if(this.externalRenderers)
      {
         ...
         while(_loc3_ < this.renderers.length)
         {
            ...
            _loc2_.removeEventListener("clickR",this,"handleItemClick");
   ...
   function setUpRenderer(clip)
   {
      ...
      clip.addEventListener("clickR",this,"handleItemClick");
