class gfx.utils.Constraints
{
   ...
   function update(width, height)
   {
      ...
      {
         _loc5_ = this.elements[_loc8_];
         _loc4_ = _loc5_.edges;
         _loc2_ = _loc5_.clip;
         _loc3_ = _loc5_.metrics;
         _loc14_ = _loc2_.width == null ? "_width" : "width";
         _loc13_ = _loc2_.height == null ? "_height" : "height";
         if(this.scaled)
         {
            ...
            if((_loc4_ & gfx.utils.Constraints.LEFT) > 0)
            {
               ...
               {
                  _loc7_ = width - _loc3_.left - _loc3_.right;
