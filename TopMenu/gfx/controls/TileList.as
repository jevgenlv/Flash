class gfx.controls.TileList extends gfx.controls.CoreList
{
   ...
   function set columnCount(value)
   {
      ...
      this.setSize(_loc2_ * this.columnCount,this.__height);
   }
   ...
   function draw()
   {
      ...
      else
      {
         ...
         this.totalRows = this.availableHeight / _loc3_ >> 0;
         this.totalColumns = this.availableWidth / _loc4_ >> 0;
